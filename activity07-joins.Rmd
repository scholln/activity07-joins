...
**Yes they are, they have locations in almost all places of the world except for the contient of Africa**:
...
**We would need to find a common key, foreign key or identical observations**:
...
**I did a quick google search to confirm but yes it looks like there are denny's locations outside of the US in Canada, Puerto Rico and Indonesia**:
...
```{r first anti join}
anti_join(dennys, states, by = c("state" = "name"))
...
**Yeah it makes sense, Maine is one of the whitest states in the united states and probably don't like spicy food**:
